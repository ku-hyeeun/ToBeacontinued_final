...
public class OutsideTodolist extends AppCompatActivity implements BeaconCallback, Runnable{
    ...
    private void showNotification(Beacon beacon) {
        ...
        Intent intent = new Intent(getApplicationContext(), OutsideTodolist.class);        //상단의 노티 클릭하면 menuactivity로 넘어옴.
